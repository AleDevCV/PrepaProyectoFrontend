...
(function () {
  ...
  function respuestaEntrega() {
    ...
    return `⏰ Preparamos cada pedido de forma artesanal según nuestra <b>capacidad diaria</b> ` +
  ...
  const INTENTS = [
    ...
    { keys: ["como hago","como hacer","como pido","como pedir","hacer un pedido","hacer pedido","quiero pedir","quiero comprar","realizar pedido","encargar","ordenar"],
      reply: () => `Hacer un pedido es muy fácil 🛒:<br><br>1️⃣ Elige tus alfajores en el <b>catálogo</b> y agrégralos al carrito.<br>2️⃣ Presiona <b>"Realizar Pedido"</b> y completa tus datos.<br>3️⃣ Paga con <b>tarjeta</b> de forma automática.<br>4️⃣ Recibes un <b>código único</b> para seguir tu pedido en tiempo real. ✨` },
    ...
    { keys: ["pago","pagar","pagos","metodo de pago","metodos de pago","qr","transferencia","efectivo","banco","adelanto","tarjeta"],
      reply: () => `Aceptamos 💳:<br><br>• <b>Pago con tarjeta</b> (Visa, Mastercard, Amex)<br>• <b>QR</b> (Mercantil Santa Cruz, Banco Unión, BCP)<br>• <b>Transferencia bancaria</b><br>• <b>Efectivo</b> (al recoger)<br><br>Puedes pagar el <b>50% de adelanto</b> o el <b>100%</b>. El pedido entra a producción una vez validado el pago. 👨‍🍳` },
